...
import com.bing.lan.mainLib.api.interceptor.AddProgressInterceptor;
import com.bing.lan.mainLib.api.interceptor.CommParaInterceptor;
...
public class ApiManager extends BaseApiManager {
    ...
    private void initJzkApiService() {
        if (mApiRetrofit == null) {
            ...
            mApiRetrofit = getRetrofit("http://192.168.0.104:8085/api/v1/");
        }
