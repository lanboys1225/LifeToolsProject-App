package com.bing.lan.mainLib.authCode;
...
public class AuthCode {
    ...
    static class AuthCodeHandler extends Handler {
        ...
        public void setCodeTextView(TextView codeView) {
            this.mTextViewRef = new SoftReference<>(codeView);
        }
    ...
    public void into(TextView codeView) {
        ...
        if (checkPermission()) {
            if (mHandler == null) {
                ...
                mHandler.setCodeTextView(codeView);
            }
        } else {
    ...
    public void onDestroy() {
        if (mContext != null && mAuthcodeIntent != null) {
