...
import static com.bing.lan.mainLib.cons.IConstants.TOTAL_WAITING_VERIFICATION_CODE_TIME_60S;
import static com.bing.lan.mainLib.cons.RequestActionCons.ACTION_CHECK_VCODE;
import static com.bing.lan.mainLib.cons.RequestActionCons.ACTION_GET_VCODE;
import static com.bing.lan.mainLib.cons.RequestActionCons.ACTION_GET_VCODE_FORGET;
    ...
    public void handleVcode(int action, Object data) {
        switch (action) {
            ...
            case ACTION_GET_VCODE_FORGET:
                ResponseResult<Object> httpResult1 = (ResponseResult<Object>) data;
